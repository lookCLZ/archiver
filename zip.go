...
func (z *Zip) Archive(sources []string, destination string, option ...string) error {
	...
	for _, source := range sources {
		err := z.writeWalk(source, topLevelFolder, destination, option[0])
		if err != nil {
...
func (z *Zip) writeWalk(source string, topLevelFolder string, destination string, option ...string) error {
